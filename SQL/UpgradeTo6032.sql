BEGIN TRANSACTION UpgradeTo6032
PRINT 'Starting upgrade to 6032'

DELETE FROM DbUpgradeLog WHERE DbVer > 6031;

EXEC DbCheckVersion 6031;
EXECUTE DbStartUpgrade 6032;
GO
...
EXECUTE dbo.DbFinalizeUpgrade 6032;
GO

COMMIT TRANSACTION UpgradeTo6032;
GO
