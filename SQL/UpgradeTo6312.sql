...
--  ALTER procedure dbo.GetUserDetails to return information about other users too.
--  ALTER procedure GBD.UpdateMustScoreForAll for better performance.
...
PRINT '--  ALTER procedure GBD.UpdateMustScoreForAll for better performance.'
GO

IF NOT OBJECT_ID('GBD.UpdateMustScoreForAll') IS NULL
  DROP PROCEDURE GBD.UpdateMustScoreForAll
GO
